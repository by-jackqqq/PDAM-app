                    ...
                    >
                        ...
                        {collapsed && (
                            <div className="
                                ...
                                opacity-0 group-hover:opacity-100 translate-x-0 transition-all duration-150
                                shadow-lg z-50
                            ">
                                {item.label}
                            </div>
...
function SidebarBody({
    ...
    return (
        <div className="flex flex-col h-full">
            {/* ── Logo ── */}
            <div
                className={`flex items-center gap-3 px-4 py-5 border-b border-white/10 shrink-0
            ...
            >
                ...
                {!collapsed && (
                    <div className="min-w-0">
                        <p className="text-white font-extrabold text-[15px] leading-tight tracking-wide truncate">
                            PDAM Smart
                        </p>
                        <p className="text-blue-200/70 text-[11px] font-medium tracking-widest uppercase">
                            Admin Panel
                        </p>
                    </div>
                )}
            ...
            {/* ── Menu label ── */}
            {!collapsed && (
                <p className="px-4 pt-4 pb-1 text-[10px] font-bold uppercase tracking-[0.12em] text-blue-200/50">
                    Navigation
                </p>
            )}
            ...
            <div className="px-2 pb-4 pt-2 border-t border-white/10 flex-shrink-0">
                <button
                    ...
                    className={`
                        ...
                        text-blue-100/80 hover:bg-red-500/20 hover:text-red-200
        ...
        <>
            ...
            <aside
                className={`
                    ...
                    bg-linear-to-b from-blue-500 via-blue-600 to-blue-700
                ...
                `}
            >
                {/* Radial glow overlay — does NOT conflict with gradient */}
                <div
                    className="absolute inset-0 pointer-events-none"
                    style={{ backgroundImage: "radial-gradient(ellipse at 80% 0%, rgba(255,255,255,0.12) 0%, transparent 55%)" }}
                />
                {/* Decorative circle */}
            ...
            {mobileOpen && (
                <div
                    className="md:hidden fixed inset-0 z-40 bg-blue-950/40 backdrop-blur-sm"
            ...
            <aside
                className={`
                    ...
                    bg-linear-to-b from-blue-600 via-blue-600 to-blue-700
